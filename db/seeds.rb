...
dream_oleole = Dream.new(name: "Rêve Oléolé", details: "Un rêve hot pour réchauffer tes nuits", content: "Une nuit d'hiver, après une longue journée de ski en haute montagne, vous êtes épuisé.e.
  Il fait froid, et une longue nuit solitaire vous attend dans votre chalet...
  Cet.te inconnu.e avec qui vous avez échangé toute la journée des regards complices et langoureux sur les pistes, vient vous aborder lorsque vous êtes en chemin pour rendre votre matériel.
...
dream_joyeux = Dream.new(name: "Rêve Joyeux", details: "Un rêve drôle qui saura te faire rire", content: "Qui n'a jamais rêvé de vivre une expérience comique unique ? Ce soir, c'est marathon de films comiques, d'humoristes sur scène, entouré.e de vos meilleurs ami.e.s
  Un seul objectif, vivre un moment de joie pure, inoubliable. Des surprises sont à prévoir, soyez ouvert.e à toute possibilité, laissez entrer le rire dans votre vie.
...
dream_apaisant = Dream.new(name: "Rêve Apaisant", details: "Un rêve relaxant pour te ressourcer ", content: "Aujourd'hui votre ami.e proche vous a réservé une journée complète dans un luxueux spa. Au programme, détente et bien être. Tous les soins sont à volonté. Que vous ayez envie d'un hammam,
  de rester toute la matinée dans un jacuzzi
  ou d'avoir accès à un massage relaxant de qualité, tout est possible. La seule issue de cette journée est une disparition complète de toute forme de stress, et un ressourcement total..." , price: 70,  user: user2)
...
dream_reconfortant = Dream.new(name: "Rêve Réconfortant", details: "Un rêve rassurant qui t'enveloppera de douceur", content: "En cette journée morose, vous décidez de reprendre votre moral en main et vous rejoignez un.e ami.e dans un refuge pour animaux.
...
dream_futuriste = Dream.new(name: "Rêve futuriste", details: "Un rêve qui te promet un voyage dans le temps inoubliale", content: "An 2198, la Terre a subi une attaque nucléaire et s'en remet très difficilement. Nous vivons en communauté dans l'espace, en espérant pouvoir un jour trouver la planète qui sera capable de
  nous accueillir...Peut-être que cette planète n'existe pas, et qu'il faut sauver la Terre avant qu'elle ne soit détruite. Le capitaine de l'équipage vous propose de retourner avant la
  date fatidique et de changer notre destinée... Arriverez-vous à sauver le futur en voyageant dans le passé ?", price: 130,  user: user2)
